              ...
              <HeaderComponent />
                <div className="container">
                    <Switch> 
                          ...
                          <Route path = "/attendance-list" exact component = {ListAttendanceComponent}></Route>
                          <Route path = "/employees" component = {ListEmployeeComponent}></Route>
                          <Route path = "/add-employee/:id" component = {CreateEmployeeComponent}></Route>
                          <Route path = "/add-attendance/:id" component = {CreateAttendanceComponent}></Route>
                          <Route path = "/view-employee/:id" component = {ViewEmployeeComponent}></Route>
                          <Route path = "/update-employee/:id" component = {UpdateEmployeeComponent}></Route>
                          <Route path = "/update-attendance/:id" component = {UpdateAttendanceComponent}></Route>
                    </Switch>
                </div>
              <FooterComponent />
        </Router>
